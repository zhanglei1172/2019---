...
omiga_change_eps = 1e-3;
omiga_serach_min = 0.01;
omiga_serach_max = 0.10;
...
param_serach_min = [omiga_serach_min, time_delay_serach_min];
param_serach_max = [omiga_serach_max, time_delay_serach_max];
param_change_eps = [omiga_change_eps, time_delay_change_eps];
search_range_param = [search_range_omiga, search_range_time_delay];
%%
cycle = 1;
T_c = param_serach_min + (1-0.618) * search_range_param;
T_d = param_serach_min + 0.618 * search_range_param;
F_c = funEval1(T_c, delta_t, period, Q_func,data_out);
F_d = funEval1(T_d, delta_t, period, Q_func,data_out);
tic
record = [];
res_record = [];
