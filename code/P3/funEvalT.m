function f = funEvalT(delta_t, period, Q_func, time_delta, data_out)
time_delta = 100 - time_delta;
global P0 rho gaoYaPipe_v data delta_theta data_shape sai_h beng_rho beng_P base_h beng_h beng_s period_out Q_function
