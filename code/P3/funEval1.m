function f = funEval1(param, delta_t, period, Q_func, data_out)
omiga = param(1);
time_delta = 100 - param(2);
global P0 rho gaoYaPipe_v data data_shape sai_h beng_rho base_h beng_h beng_s period_out Q_function
