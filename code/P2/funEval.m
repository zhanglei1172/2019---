function f = funEval(omiga, delta_t, period, Q_func)
global P0 rho gaoYaPipe_v weight data data_shape sai_h beng_rho beng_P base_h beng_h beng_s period_out Q_function
