...
% 局部放大图
figure()
plot(0:delta_t:1000, P0(1:length(0:delta_t:1000)))
xlabel('时间(ms)')
ylabel('压力(MPa)')
% smooth_P = P0;
% w = 0.99999;
% for i = 2:length(P0)
%     smooth_P(i) = smooth_P(i-1)*w + (1-w)*P0(i);
% end
% smooth_P2 = smooth_P;
% w = 0.99999;
% for i = 2:length(smooth_P)
%     smooth_P2(i) = smooth_P2(i-1)*w + (1-w)*smooth_P(i);
% end
% hold on
% plot(0:delta_t:period, smooth_P2(1:end-1), 'LineWidth',2)
% profile viewer