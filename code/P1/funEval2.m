function f = funEval(param, delta_t, period, Q_func, RHO, dest)
global P0 rho gaoYaPipe_v poly weight data second
...
% f = weight(end-3e3/delta_t:end-1) * abs(dest - P0(end-3e3/delta_t:end-1));
f = mean(abs(P0(end-20001:end-1)-dest));
